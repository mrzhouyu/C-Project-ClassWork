...
public:
	...
	afx_msg void WaveInOpen( WPARAM wParam, LPARAM lParam ) ;
	afx_msg void WaveInData( WPARAM wParam, LPARAM lParam ) ;
	afx_msg void WaveInClose( WPARAM wParam, LPARAM lParam ) ;
